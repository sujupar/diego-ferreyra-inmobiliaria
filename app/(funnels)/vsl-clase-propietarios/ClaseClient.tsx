  ...
  return (
    <main>
      ...
      {testimonials.length > 0 && (
        <section data-hm="social-proof" className="bg-[#F8F9FA] py-16">
      ...
      {/* ¿Quién soy? */}
      <section data-hm="bio" className="mx-auto flex max-w-4xl flex-col items-center gap-8 px-4 py-16 md:flex-row">
        <Image
          src={headshotUrl}
          alt={C.bio.name}
          width={220}
      ...
      <section data-hm="cta-final" className="bg-[#0d2d49] py-16 text-center">
        <ScrollReveal>
          <div className="px-4">
            <Cta onClick={openModal} onPrime={prime} label={C.cta.label} note={C.cta.note} />
          </div>
