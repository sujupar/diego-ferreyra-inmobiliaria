...
export async function middleware(request: NextRequest) {
  ...
  if (
    ...
    // Rutas públicas: pasan sin tocar la sesión. Hasta el 2026-09-19 acá se dejaba
    // la cookie `df_lp_roll` (el número del reparto A/B por visitante). El reparto
    // ahora es por clic y se sortea en la página, así que el middleware ya no
    // participa del A/B. Las cookies viejas vencen solas; nadie las lee.
