...
/**
 * Cliente de WhatsApp vía Meta Cloud API (Graph).
 *
 * Mensajes iniciados por el negocio (los asesores no están en una ventana de
 * 24h) ⇒ SOLO se pueden enviar con una PLANTILLA pre-aprobada por Meta.
 *
 * Modo prueba (WHATSAPP_TEST_MODE=true o falta de credenciales): no envía nada,
 * loguea y devuelve { ok:true, skipped:true } — espeja el test-mode de Resend.
 *
 * Env vars:
