/**
 * Sistema de diseño de los carruseles (identidad de marca + layouts).
 * Portado de scripts/carousel/kit.ts para uso server-side. Es la base de las
 * plantillas: cada layout de slide se arma con estos helpers.
 */
import { h, type El } from './render'
