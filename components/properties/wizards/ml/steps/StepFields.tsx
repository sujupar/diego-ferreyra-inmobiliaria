...
import type { AttributeOverride } from '@/lib/portals/mercadolibre/category-attributes'
import type { MlAttributesResponse, MlDraft, MlPreviewProperty } from '../types'
// El control de cada atributo se comparte con Argenprop y con la Sección 08 de la visita.
import { AttrField, hasValue } from '../../AttrField'
